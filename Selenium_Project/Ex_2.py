...
speakers_product_id_24 = driver.find_element(By.ID, "24")
speakers_product_id_24.click()

speakers_product_id_24_color = driver.find_element(By.CSS_SELECTOR, "#bunny[title='GRAY']")
speakers_product_id_24_color.click()
...
element = driver.find_element(By.CLASS_NAME, "div.logo>a>span.roboto-medium")
